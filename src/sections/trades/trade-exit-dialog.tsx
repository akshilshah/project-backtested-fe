    ...
    <Box>
      {label && (
        <Stack direction="row" spacing={0.75} alignItems="center" sx={{ mb: 1 }}>
          {icon && (
            <Iconify icon={icon as any} width={14} sx={{ color: 'text.secondary' }} />
          )}
          <Typography
            variant="caption"
            sx={{
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          <Box
            sx={{
              ...
              borderRadius: 1.5,
              bgcolor: (t: Theme) =>
                t.palette.mode === 'dark' ? 'rgba(245, 158, 11, 0.16)' : 'rgba(245, 158, 11, 0.1)',
            }}
          >
            <Iconify
              icon={'solar:logout-2-bold' as any}
              width={22}
          ...
          <Box>
            ...
            <Typography variant="caption" color="text.secondary">
              Close your position and realize P&L
            </Typography>
          </Box>
        </Stack>
      </DialogTitle>
